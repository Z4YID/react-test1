        ...
        <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="140px" gap="20px">
            ...
            <Box gridColumn="span 8" gridRow="span 2" backgroundColor={colors.primary[400]} >
                <Box mt ="25px" p="0 30px" display="flex" justifyContent="space-between" alignItems="center">
                    ...
                    <Box>
                        <IconButton>
                            <DownloadOutlinedIcon sx={{ color: colors.greenAccent[600], fontSize: "26px"}}/>
                        </IconButton>
                    </Box>
                </Box>
            ...
            <Box gridColumn="span 4" gridRow="span 2" backgroundColor={colors.primary[400]} overflow="auto" >
                ...
                {mockTransactions.map((transaction,i) => (
                    ...
                    >
                        <Box>
                            <Typography color={colors.greenAccent[100]} variant="h5" fontWeight="600">{transaction.txId}</Typography>
            ...
            >
                ...
                <Box display="flex" flexDirection="column" alignItems="center" mt="25px">
                    ...
                    <Typography variant="h5" color={colors.greenAccent[500]} sx={{mt: "15px"}}>$49,201 revenue generated</Typography>
                    <Typography variant="h5" fontWeight="600">Includes overhead</Typography>
                </Box>
            </Box>
            <Box gridColumn="span 4" 
                gridRow="span 2"
